	...
	<div id="app">
		<div class="main-wrapper container">
			...
			<nav class="navbar navbar-expand-lg main-navbar">
				...
				<form class="form-inline ml-auto" action="<?php echo site_url('recommendation')?>" method="post">
					<ul class="navbar-nav">
					...
					<div class="search-element">
						...
						<!--Sampe sini  Bikin FOrm-->
					</div>
				</form>
				<a href="<?php echo site_url('wishlist');?>">
					<button type="button" class="btn btn-outline-light ml-3"><i class="fas fa-heart"></i></button>
				</a>
				<a href="<?php echo site_url('member/keranjang');?>">
					<button type="button" class="btn btn-outline-light ml-3"><i class="fas fa-shopping-cart"></i></button>
				</a>
				<ul class="navbar-nav navbar-right">

					<li><a href="http://localhost/tokokita/index.php/member/keranjang"><i class="fas fa-bell"></i></a>
