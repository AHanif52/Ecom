                  ...
                  <div class="row">
                    <div class="col-sm-6">
                      ...
                      <ul class="list-unstyled list-unstyled-border list-unstyled-noborder mb-0">
                        <li class="media">
                          <img class="img-fluid mt-1 img-shadow" src="<?php echo base_url('assets/admin/node_modules/flag-icon-css/flags/4x3/id.svg');?>" alt="image" width="40">
                        ...
                        <li class="media">
                          <img class="img-fluid mt-1 img-shadow" src="<?php echo base_url('assets/admin/node_modules/flag-icon-css/flags/4x3/my.svg');?>" alt="image" width="40">
                          <div class="media-body ml-3">
