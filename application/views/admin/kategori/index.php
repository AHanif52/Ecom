      								...
      								<table class="table table-bordered table-md">
										...
										<?php foreach ($kategori as $item) { ?>
      									<tr>
      										...
      										<td><a href="<?php echo site_url('kategori/getid/'.$item->idkat); ?>" class="btn btn-warning">Edit</a>   <a href="<?php echo site_url('kategori/delete/'.$item->idkat); ?>" class="btn btn-danger">Hapus</a></td>
      									</tr>
      									<?php } ?>
      								</table>
      							</div>
