        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
              ...
              <li class="nav-item dropdown">
                <a href="#" class="nav-link has-dropdown"><i class="fas fa-plane"></i> <span>Ongkir</span></a>
                <ul class="dropdown-menu">
                  <li><a class="nav-link" href="<?php echo site_url('kota');?>"><i class="fas fa-city"></i>Kota</a></li>
                  <li><a class="nav-link" href="<?php echo site_url('Kurir');?>"><i class="fas fa-box"></i>Kurir</a></li>
                  <li><a class="nav-link" href="<?php echo site_url('Ongkir');?>"><i class="fas fa-credit-card"></i>Biaya Kirim</a></li>
                </ul>
              </li>
              <li class="nav-item">
                <a href="<?php echo site_url('akunmember');?>" class="nav-link"><i class="fas fa-user"></i> <span>Member</span></a>
              </li>
            </ul>
        </aside>
      </div>
